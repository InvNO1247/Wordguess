...
var wordSelection = ["The Matrix", "Braveheart", "Planet of the Apes", "The Dark Knight", "The Princess Bride", "Serenity", "Goodwill Hunting", "The Shawshank redemption", "Jaws", "Whiplash", "Interstellar"];
var currentWord;
...
function guessPrompt() {
    ...
    // If the word has not been guessed, display prompt
        ...
        if (firstGame) {
            console.log("Try to guess my favorite movies!".magenta);
